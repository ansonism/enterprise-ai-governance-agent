# SKILL.md — Enterprise AI Governance Agent
...
- Data classifications and data flows
- Tools, APIs, credentials and permissions
- Model/provider metadata
- Policies, standards, control frameworks and evaluation evidence

    ## 4. Required outputs

    - Governance risk rating
- Control coverage matrix
- Policy violations and missing evidence
...
- `audit_writer`
    ...
    - 1. `inventory_ai_system`
- 2. `classify_use_case_and_data`
- 3. `map_policies_and_controls`
- 4. `evaluate_identity_permissions_and_tool_access`
- 5. `evaluate_privacy_security_and_data_handling`
- 6. `evaluate_model_and_agent_risk`
- 7. `check_evaluation_and_monitoring_evidence`
- 8. `compute_governance_posture`
- 9. `produce_remediation_and_approval_plan`
    ...
    Maintain a provider-neutral interface in `src/ai_governance/providers/base.py`.
