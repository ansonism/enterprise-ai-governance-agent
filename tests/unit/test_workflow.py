...
from ai_governance.models import EvidenceInput, GovernanceAssessmentInput, RunStatus
from ai_governance.persistence import InMemoryRunStateRepository
from ai_governance.providers.mock import MockProvider
from ai_governance.workflow import DEFAULT_STAGES, Workflow

NOW = datetime(2026, 1, 1, tzinfo=UTC)


def request() -> GovernanceAssessmentInput:
    return GovernanceAssessmentInput(
        case_id="test-001",
