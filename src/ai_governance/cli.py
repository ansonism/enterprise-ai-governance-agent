...
from .models import ExecutionContext, GovernanceAssessmentInput
from .observability import configure_logging
from .persistence import JsonRunStateRepository
from .providers.mock import MockProvider
from .workflow import Workflow

app = typer.Typer(help="Enterprise AI Governance Agent")
...
def run(
    ...
    try:
        request = GovernanceAssessmentInput.model_validate_json(
